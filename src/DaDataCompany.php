...
use Darkeum\DaData\Enums\BranchType;
use Darkeum\DaData\Enums\CompanyScope;
use Darkeum\DaData\Enums\CompanyStatus;
use Darkeum\DaData\Enums\CompanyType;

/**
 * Class DaDataPhone
 * @package Darkeum\DaData
 */
